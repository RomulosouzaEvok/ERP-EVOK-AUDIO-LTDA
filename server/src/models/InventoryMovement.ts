...
const InventoryMovement = sequelize.define('InventoryMovement', {
  ...
  operation_id: { type: DataTypes.UUID, allowNull: true, comment: 'Chave de idempotência da operação HTTP (rota POST /api/inventory/movements)' },
  ...
  indexes: [
    ...
    { unique: true, fields: ['operation_id'], where: { operation_id: { [Op.ne]: null } } },
