 ...
 *
 * `PUT /:id/reassign` (achado de auditoria 2026-08-06, item 1a) também
 * exige `approve` — reatribuir o responsável por uma contagem é decisão de
 * gestor da área, mesmo nível de aprovar/rejeitar.
 */
...
router.put('/:id/reassign', authenticate, authorizeModule('contagens', 'approve'), inventoryCountController.reassign);
