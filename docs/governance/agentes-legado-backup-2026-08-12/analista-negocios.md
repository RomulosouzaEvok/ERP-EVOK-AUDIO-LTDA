...
> Cópia congelada de `.claude/agents/analista-negocios.md` do roster de 21 agentes
...
2. Atualize o arquivo `docs/governance/HANDOFF_CODEX.md` informando ao Agente Programador, `AdmDBA` ou `ArquitetoSoftwareAPI` que "Os requisitos da Funcionalidade X estão prontos" e indique os links/nomes dos arquivos `.md` que eles devem ler para começar a codificar.
