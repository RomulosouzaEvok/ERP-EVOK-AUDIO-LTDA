...
> Cópia congelada de `.claude/agents/adm-dba.md` do roster de 21 agentes
...
1. Atualize OBRIGATORIAMENTE `docs/database/02-MODELO_LOGICO.md`, `04-DICIONARIO_DADOS.md` e, se aplicável, `05-ACESSOS_E_ISOLAMENTO.md`/`06-ESTRUTURAS_PROGRAMAVEIS.md` detalhando as novas tabelas, colunas, tipos e relacionamentos. `docs/database/DATABASE.md` (raiz de `docs/`) é só o changelog histórico curto que aponta para essa pasta — não duplique conteúdo lá.
2. Atualize o `docs/governance/HANDOFF_CODEX.md` avisando ao Agente Programador ou QA que o schema do banco mudou, listando as novas colunas para que ele possa atualizar o código.
