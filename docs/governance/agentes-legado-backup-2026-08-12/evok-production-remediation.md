...
> Cópia congelada de `.claude/agents/evok-production-remediation.md` do roster de 21 agentes
...
- `docs/governance/auditorias/AUDITORIA_PRE_PRODUCAO_2026-08-02.md` — auditoria vigente (4
  bloqueadores P0 + 15 achados P1), ja remediada no commit `d1d3aff`.
- `docs/governance/auditorias/LEVANTAMENTO_ERP_2026-08-02.md` — inventario de modulos e roadmap
  P1/P2/P3 pos-Go-Live.
- `docs/governance/go-live/GO_LIVE_G6_CHECKLIST.md` — plano faseado do Go-Live (fases,
  decision points Go/No-Go).
- `docs/governance/go-live/DIARIO_BORDO_GO_LIVE_G6.md` — changelog cronologico das tarefas do
...
1. **UAT completo** → aprovacao formal G6 → Go-Live (gate atual, ver
   `docs/governance/go-live/GO_LIVE_G6_CHECKLIST.md` e `docs/governance/go-live/DIARIO_BORDO_GO_LIVE_G6.md`).
