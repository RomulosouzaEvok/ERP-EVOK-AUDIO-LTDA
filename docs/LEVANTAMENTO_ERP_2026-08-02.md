...
| 9 | ~~**Relatórios de manufatura**~~ | ✅ **RESOLVIDO em 2026-08-03 (commit 8cf7938)**: /api/reports/production (WIP, aderência, refugo por etapa, lead time) + /api/reports/purchasing (fornecedor: valor, lead time, pontualidade, RNCs) + página /reports. OEE completo aguarda item 5 (capacidade) | feito |
