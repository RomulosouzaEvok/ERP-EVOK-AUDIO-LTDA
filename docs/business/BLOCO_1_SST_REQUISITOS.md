...
| RNF-SST-04 | Cálculo do prazo legal da CAT (1º dia útil seguinte à ocorrência) deve considerar calendário de dias úteis e feriados nacionais (mínimo); o alerta deve escalonar (SST → gestor SST) conforme o prazo se aproxima, não apenas notificar uma vez | Novo — não coberto no RNF geral (sem menção a calendário de negócio hoje) |
