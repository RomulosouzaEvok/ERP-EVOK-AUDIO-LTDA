...
# 2b. Definir ADMIN_SEED_PASSWORD no .env — OBRIGATÓRIO para o seed do admin.
#     O compose agora exige essa variável na API e o seed não aceita fallback
...
placeholder ou curta, o erro é proposital: defina a variável real antes do
primeiro boot para que a conta inicial não nasça com credencial fraca.
```
